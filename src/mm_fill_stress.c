				      ...
				      if ( pd->TimeIntegration != STEADY )
					{
					  if ( pd->e[0][eqn] & T_MASS )
					      ...
					      if(supg!=0.)
						{
					      ...
					      mass *= pd->etm[0][eqn][(LOG2_MASS)] * lambda * det_J * wt * h3;
					    }
			      ...
			      if ( pd->v[0][var] )
				{
				  ...
				  for ( j=0; j<ei->dof[var]; j++)
				      ...
				      if ( pd->e[0][eqn] & T_ADVECTION )
					{
					  if(lambda != 0.)
					      ...
					      if(supg!=0.)
						{
					      ...
					      advection *=  wt * lambda * pd->etm[0][eqn][(LOG2_ADVECTION)];
				      ...
				      if ( pd->e[0][eqn] & T_SOURCE )
					{
					  ...
					  source *=  wt * pd->etm[0][eqn][(LOG2_SOURCE)];
				      ...
				      for ( j=0; j<ei->dof[var]; j++)
					{
					  ...
					  if ( pd->TimeIntegration != STEADY )
					      ...
					      if ( pd->e[0][eqn] & T_MASS )
						{
						  ...
						  mass *= wt_func * lambda * wt * pd->etm[0][eqn][(LOG2_MASS)];
						}
					    }
					  ...
					  if ( pd->e[0][eqn] & T_ADVECTION )
					      ...
					      if(lambda != 0.)
						{
						  ...
						  advection *= wt_func * wt * lambda * pd->etm[0][eqn][(LOG2_ADVECTION)];
						} 
					    }
					  ...
					  if ( pd->e[0][eqn] & T_SOURCE )
					      ...
					      if(alpha != 0.)
						{
					      ...
					      source *= det_J * h3 * wt_func * wt * pd->etm[0][eqn][(LOG2_SOURCE)];
				      ...
				      if ( pd->TimeIntegration != STEADY )
					{
					  if ( pd->e[0][eqn] & T_MASS )
					      ...
					      if(supg!=0.)
						{
					      ...
					      mass *= pd->etm[0][eqn][(LOG2_MASS)] * at * lambda * det_J * wt * h3;
					    }
				      ...
				      if ( pd->TimeIntegration != STEADY )
					{
					  if ( pd->e[0][eqn] & T_MASS )
					      ...
					      if(supg != 0.)
						{
					      ...
					      mass = mass_a + mass_b;
					      mass *= at * lambda * wt * pd->etm[0][eqn][(LOG2_MASS)];
					    }
					}
				      ...
				      if ( pd->e[0][eqn] & T_ADVECTION )
					{
					  if(lambda != 0.)
					      ...
					      if(supg!=0.)
						{
					      ...
					      advection *=  wt * at * lambda * pd->etm[0][eqn][(LOG2_ADVECTION)];
				      ...
				      for ( j=0; j<ei->dof[var]; j++)
					{
					  ...
					  if ( pd->e[0][eqn] & T_ADVECTION )
					      ...
					      if(lambda != 0.)
						{
						  ...
						  advection *= wt_func * wt * at * lambda * pd->etm[0][eqn][(LOG2_ADVECTION)];
						} 
					    }
				      ...
				      for ( j=0; j<ei->dof[var]; j++)
					{
					  ...
					  if ( pd->TimeIntegration != STEADY )
					      ...
					      if ( pd->e[0][eqn] & T_MASS )
						{
						  mass = (1.+2.*tt) * phi_j/dt * (double)delta(a,p) * (double)delta(b,q); 
						  mass *= h3 * det_J;
						  mass *= wt_func * at * lambda * wt * pd->etm[0][eqn][(LOG2_MASS)];
						}
					    }
				      ...
				      if ( pd->TimeIntegration != STEADY )
					{
					  if ( pd->e[0][eqn] & T_MASS )
					      ...
					      if(supg!=0.)
						{
					      ...
					      mass *= pd->etm[0][eqn][(LOG2_MASS)] * det_J * wt * h3;
					    }
			      ...
			      if ( pd->v[0][var] )
				{
				  ...
				  for ( j=0; j<ei->dof[var]; j++)
				      ...
				      if ( pd->TimeIntegration != STEADY )
					{
					  if ( pd->e[0][eqn] & T_MASS )
					      ...
					      if(supg != 0.)
						{
					      ...
					      mass = mass_a + mass_b;
					      mass *= wt * pd->etm[0][eqn][(LOG2_MASS)];
					    }
					}
				      ...
				      if ( pd->e[0][eqn] & T_ADVECTION )
					{
					  ...
					  advection *=  wt * pd->etm[0][eqn][(LOG2_ADVECTION)];
					  ...
					  if ( pd->e[0][eqn] & T_ADVECTION )
					    {
					      ...
					      advection *= wt_func * wt * H_ls / Gmod * pd->etm[0][eqn][(LOG2_ADVECTION)];
					    }
				      ...
				      for ( j=0; j<ei->dof[var]; j++)
					{
					  ...
					  if ( pd->TimeIntegration != STEADY )
					      ...
					      if ( pd->e[0][eqn] & T_MASS )
						{
						  mass = (1.+2.*tt) * phi_j/dt * (double)delta(a,p) * (double)delta(b,q); 
						  mass *= h3 * det_J;
						  mass *= wt_func * H_ls / Gmod * wt * pd->etm[0][eqn][(LOG2_MASS)];
						}
					    }
      ...
      for( a=0; a<DIM; a++)
	{
	  for( b=0; b<DIM; b++)
	      ...
	      if( a <= b )
		{
		  ...
		  if( pd->e[0][eqn] && ( ldof_eqn = ei->ln_to_first_dof[eqn][ln] != -1 ) )
		    {
		      ieqn = upd->ep[0][eqn];
				  ...
				  if( p <= q && delta(a,p) && delta(q,b) )
				    {
				      ...
				      if( pd->v[0][var] && (ldof_var = ei->ln_to_first_dof[var][ln] != -1 ) )
					{
					  pvar = upd->vp[0][var];
